...
export default function AddProductModal({ onSave }) {
  ...
  const handleCompatibilityChange = (idx, field, value) =>
    setForm((p) => ({
      ...p,
      compatibility: p.compatibility.map((c, i) =>
    ...
    <div>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 bg-white sticky top-0 z-10 text-black">
            ...
            <form
              ...
              className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 text-black"
            >
              ...
              <div className="flex flex-col gap-4 lg:col-span-1">
                <div className="grid grid-cols-2 gap-2">
                  {[0, 1].map((i) => (
                    ...
                    >
                      ...
                      <div className="mt-3 w-full flex gap-2 text-black">
                        <input
                          ref={i === 0 ? fileInputRef1 : fileInputRef2}
                          type="file"
                          accept="image/*"
                          className="hidden"
                        ...
                        <button
                          ...
                          className="flex-1 inline-flex text-sm items-center text-black justify-center gap-2 py-2 rounded-lg bg-white border border-gray-200 hover:bg-gray-50"
                        >
                          <FiUpload />
                      ...
                      <div className="w-full mt-3">
                        ...
                        <input
                          ...
                          className="mt-1 w-full border border-gray-200 rounded px-2 py-2 text-sm"
                        />
                        <p className="text-xs text-gray-400 mt-1">
                          You can either upload or paste a direct image URL.
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    onClick={() => {
                      navigator.clipboard && form.images[0]
                        ? navigator.clipboard.writeText(form.images[0])
                        : null;
                      alert(
                        form.images[0]
                          ? "Image URL copied"
              ...
              <div className="lg:col-span-2 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="flex items-end">
                    <label className="w-full text-sm font-medium text-gray-700 mb-1">
                      Is New?
                    </label>
                ...
                <p className="text-xs text-gray-400 mt-2">
                  * Fields SKU, Title and Stock are required. Upload images
                  before saving for best results.
                </p>
              </div>
            </form>
          </div>
