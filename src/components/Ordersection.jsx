...
import { FiEye, FiEdit, FiTrash2,FiShoppingCart ,FiPackage ,FiTruck ,FiCheckCircle , FiPlus, FiFilter, FiDownload, FiSearch, FiChevronDown } from 'react-icons/fi';
...
export default function OrderSection() {
  const [orders, setOrders] = useState([
    ...
    { 
      ...
      payment: 'Pending',
      itemsDetail: [
        { name: 'Laptop', quantity: 2, price: 1200 },
        { name: 'Headset', quantity: 3, price: 150 }
      ]
    },
    { 
      id: 'ORD-004', 
      customer: 'XYZ Ltd', 
      email: 'purchase@xyz.com', 
      date: '2023-04-12', 
      items: 1, 
      amount: 1550, 
      status: 'Cancelled',
      payment: 'Refunded',
      itemsDetail: [
        { name: 'Gaming PC', quantity: 1, price: 1550 }
      ]
    },
    { 
      id: 'ORD-005', 
      ...
      payment: 'Paid',
      itemsDetail: [
        { name: 'Keyboard', quantity: 2, price: 85 },
        { name: 'Mouse', quantity: 2, price: 45 }
      ]
    },
  ]);
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredOrders.map(order => (
                <tr key={order.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{order.items}</td>
